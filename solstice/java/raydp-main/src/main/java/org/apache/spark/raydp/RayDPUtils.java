...
public class RayDPUtils {
  ...
  public static String dependency(String packages, String ivyPath, String ivySetting) {
      Seq<String> deps = DependencyUtils.resolveMavenDependencies(true,
          "", packages, "", ivyPath, Option.apply(ivySetting));
      return deps.mkString(":");
  }
}
